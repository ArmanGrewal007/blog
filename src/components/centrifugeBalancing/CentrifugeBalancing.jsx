...
export default function CentrifugeBalancing() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-white/30 backdrop-blur-md rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] text-gray-900 w-full max-w-2xl mx-auto border border-white/40 my-8 relative overflow-hidden">
